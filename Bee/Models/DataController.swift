...
class DataController: ObservableObject {
    ...
    /// Initilizes a data controller, either in memory (for temporary use such as testing and previewing),
    /// or on permament storage (for use in regular app runs).
    ///
    ...
    init(inMemory: Bool = false) {
        ...
        //For test testing and previewing purposes, we created a temporary
        ...
        container.loadPersistentStores { _, error in
            if let error = error {
                fatalError("Fatal error loading stor: \(error.localizedDescription)")
            }
        }
    }
    ...
    static var preview: DataController = {
        ...
        do {
            ...
            fatalError("Fatal errror creating preview: \(error.localizedDescription)")
        }
