...
struct EditProjectView: View {
    ...
    var body: some View {
        Form {
            ...
            Section(footer: Text("Closing a project move it from the Open to Closed tab; deleting it removes the project entirely.")) {
                Button(project.closed ? "Reopen this project" : "Close this projet.") {
